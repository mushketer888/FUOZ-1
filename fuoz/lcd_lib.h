...
#define LCD_E	3	//define MCU pin connected to LCD E  zajuzal 4 pin porta 3 pin perivanie int0
...
void LCDstring(char*, uint8_t);	//Outputs string to LCD					govno wlet a ne stroku
void LCDGotoXY(uint8_t, uint8_t);	//Cursor to X Y position
void CopyStringtoLCD(const uint8_t*, uint8_t, uint8_t);//copies flash string to LCD at x,y		 tozhe hz 4to glju4naja
